  ...
  class Swiper{
    constructor(selector, opts){
		...
		animate(){
			...
			util.animate(this.sliders[this.sliderIndex], 'opacity', 1, 0.5, animationDuration / 2, () => {
				this.sliders[this.sliderIndex].style.display = 'none'
				this.sliders[this.nextSliderIndex].style.display = 'block'
				util.animate(this.sliders[this.nextSliderIndex], 'opacity', 0.2, 1, animationDuration / 2, () => {
